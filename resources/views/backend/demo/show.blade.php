...
{!! Form::model($demo) !!}
    ...
    <div class="row">
        ...
        <div class="col-12 form-group">
            {!! Form::text('date', $demo->date->format('d/m/Y'), ['class' => 'form-control date-readonly', 'placeholder' => __('Fecha'), 'readonly']) !!}
        </div>
        <div class="col-12 form-group">
            {!! Form::text('address', null, ['class' => 'form-control', 'placeholder' => __('Lugar'), 'readonly']) !!}
        </div>
        <div class="col-12 form-group">
        ...
        <div class="col-12 form-group">
            {!! Form::select('values[]', $data['values'], null, ['class' => 'form-control', 'id' => 'values', 'multiple', 'disabled']) !!}
        </div>
        <div class="col-12 form-group">
            {!! Form::select('condition_id', $data['conditions'], null, ['class' => 'form-control', 'placeholder' => '+ ' . __('Estatus'), 'disabled']) !!}
        </div>
        <div class="col-12 form-group">
